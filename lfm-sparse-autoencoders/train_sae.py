...
# This is running in a Kaggle env
...
def main() -> None:
    ...
    cfg = LanguageModelSAERunnerConfig(
        ...
        # threshold in normalised-activation space while the folded encoder
        ...
        # vs sqrt(d)=32, making the mismatch a ~20x factor. Here, K sets the
        # sparsity during training regardless of normalisation.
